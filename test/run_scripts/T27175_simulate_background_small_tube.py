...
def create_settings_dict():
    ...
    settings_dict["tube_mua"] = [8., 10.]
    settings_dict["tube_mus"] = [50., 150.]
    settings_dict["tube_g"] = [0.8, 1.]
    settings_dict["tube_radius"] = [1.0, 5.]
...
def set_validation_settings(path):
    ...
    iteration_dict ["tube_center_depth"] = randomize(0., 17.,)[0],
    iteration_dict ["tube_center_x"] = randomize(0., 17.,)[0],
...
volume_info_path = "/workplace/data/3D/20200408_optical_prop_bg_5_tubes",
