...
def create_settings_dict():
    ...
    settings_dict["randomness"] = True
    settings_dict["background_mua"] = [0.00001, 0.00001]
    settings_dict["background_mus"] = [100., 100.]
    settings_dict["background_g"] = [0.9, 0.9]
    settings_dict["background_options"] = [3., 3.]

    settings_dict["tube_mua_1"] = [8., 8.]
    settings_dict["tube_mua_2"] = [6., 6.]
    settings_dict["tube_mus_1"] = [100., 100.]
    settings_dict["tube_mus_2"] = [100., 100.]
    settings_dict["tube_g"] = [0.9, 0.9]
    settings_dict["tube_radius_1"] = [3, 3.]
    settings_dict["tube_radius_2"] = [7., 7.]
...
def create_rd_boundary_settings_dict():
    ...
    rd_boundary_settings_dict["tube_center_depth_1"] = [6., 6.]
    rd_boundary_settings_dict["tube_center_x_1"] = [15., 15.]

    rd_boundary_settings_dict["tube_center_depth_2"] = [10., 10.]
    rd_boundary_settings_dict["tube_center_x_2"] = [25., 25.]
...
def create_random_structures(settings_dict, rd_boundary_settings_dict, geometries_dict):
    number_of_structures_per_sim = 3
...
volume_info_path = "/workplace/data/2D/20200721_optical_prop_bg_2_tubes_RL",
...
while seed_index < 10:
    ...
    settings = {
        ...
        Tags.SPACING_MM: 0.5,
        Tags.DIM_VOLUME_Z_MM: 40,
        Tags.DIM_VOLUME_X_MM: 40,
        Tags.DIM_VOLUME_Y_MM: 40,
        Tags.ILLUMINATION_POSITION: [41, 41, 1],
    ...
    if seed_index <= 1000:
        ...
        #mua = np.random.rand(1,1, 32, 32) + 1.
        # mua = np.zeros((1,1,4,4))+1.
        # mua = mua.round()
        ...
        pickle_out.close()  
        new_dict["background_mua"] = [2., 2.]      
        new_dict['tube_mua_1'] = [2., 2.]
        new_dict['tube_mua_2'] = [2., 2.]
        new_dict['tube_mus_1'] = [100., 100.]
        new_dict['tube_mus_2'] = [100., 100.]

        mua = np.zeros((1,1,4,4))+ 6. 
        mua = mua.round()
        ...
        [settings_path, optical_path, acoustic_path, reco_path] = simulate(settings, mua=mua)
