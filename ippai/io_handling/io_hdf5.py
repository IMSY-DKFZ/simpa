...
# import torch
# for image in range(47890, 47891):
#     props_orig = load_hdf5("/media/kris/Extreme SSD/tmp/forearm_0{}/spacing_0.34/ippai_output.hdf5".format(image), SaveFilePaths.SIMULATION_PROPERTIES.format(Tags.ORIGINAL_DATA, 800))
#     props_ups = load_hdf5("/media/kris/Extreme SSD/tmp/forearm_0{}/spacing_0.34/ippai_output.hdf5".format(image), SaveFilePaths.SIMULATION_PROPERTIES.format(Tags.UPSAMPLED_DATA, 800))
#
#
...
#     plt.subplot(2, 3, 2)
#     plt.title("orig_mua")
#     plt.imshow(props_orig["mua"])
#
#     plt.subplot(2, 3, 3)
#     plt.title("orig_sos")
#     plt.imshow(props_orig["sos"])
#
#     plt.subplot(2, 3, 4)
#     plt.title("ups_seg")
#     plt.imshow(props_ups["seg"])
#
#     plt.subplot(2, 3, 5)
#     plt.title("ups_mua")
#     plt.imshow(props_ups["mua"])
#
#     plt.subplot(2, 3, 6)
#     plt.title("ups_sos")
#     plt.imshow(props_ups["sos"])
#     plt.show()
#
#
#
