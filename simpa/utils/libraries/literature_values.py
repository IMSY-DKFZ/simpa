...
class StandardProperties:
    ...
    ALPHA_COEFF_GENERIC = 1e-4#0.02  # dB/cm/MHz
    ALPHA_COEFF_AIR = 1e-4#3.3875e-3
    ALPHA_COEFF_MUSCLE = 1e-4#0.6175
    ALPHA_COEFF_BONE = 1e-4#4.7385  # Cortical bone
    ALPHA_COEFF_BLOOD = 1e-4#0.20
    ALPHA_COEFF_SKIN = 1e-4#0.35
    ALPHA_COEFF_FAT = 1e-4#0.3785
    ALPHA_COEFF_GEL_PAD = 1e-4#0.277
    ALPHA_COEFF_WATER = 1e-4#2.1976e-3
