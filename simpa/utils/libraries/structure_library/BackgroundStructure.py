...
class Background(GeometricalStructure):
    ...
    def __init__(self, global_settings: Settings, single_structure_settings: typing.Optional[Settings] = None):
        if single_structure_settings is not None:
            single_structure_settings[Tags.PRIORITY] = 0
            single_structure_settings[Tags.CONSIDER_PARTIAL_VOLUME] = False
