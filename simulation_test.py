...
general_settings = {
            ...
            Tags.VOLUME_NAME: "RealisticSensor_" + str(RANDOM_SEED) if DEGRADATION else \
                "RealisticSensor_Reference_without_Degradation_" + str(RANDOM_SEED),
...
settings["sensor_efficiencies"] = {
    Tags.DEGRADATED_SENSORS: 256,
    Tags.DEGRADATION_FACTORS: np.random.rand(256)*0.2+0.9,
    Tags.SHIFT_TS: 2300
}

settings["3_broken_sensors"] = {
    Tags.DEGRADATED_SENSORS: 3,
    Tags.DEGRADATION_FACTORS: 1.,
    Tags.SHIFT_TS: [2100, 2150, 2200]
}
...
if DEGRADATION:
    SIMULATION_PIPELINE = [
        ...
        sp.SensorEfficiencies(settings, "sensor_efficiencies") ,
        sp.SensorDegradation(settings, "3_broken_sensors"),
