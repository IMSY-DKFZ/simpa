...
def get_lymph_node_reference_dictionary(only_use_NIR_values=False):
    ...
    values450nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values500nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values550nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values600nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values650nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values700nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values750nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values800nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values850nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values900nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
    ...
    values950nm[Tags.DATA_FIELD_OXYGENATION] = 0.84
