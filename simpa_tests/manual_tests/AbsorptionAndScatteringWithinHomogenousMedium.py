...
class TestAbsorptionAndScatteringWithInifinitesimalSlabExperiment():
    ...
    def test_low_scattering(self):
        ...
        """
        self.perform_test(absorption_value_1=0.01,
...
if __name__ == '__main__':
    ...
    test.setUp()
    test.simulate_perfect_result()
    test.test_low_scattering()
    test.test_medium_scattering()
    test.test_high_scattering_025()
    test.test_high_scattering_075()
    test.test_high_scattering_090()
    test.test_ignore_mcx_anisotropy_025()
    test.test_ignore_mcx_anisotropy_075()
