...
from simpa import KWaveAdapter, MCXAdapter, \
    DelayAndSumAdapter, ModelBasedAdapter, GaussianNoise
...
class DelayAndSumReconstruction(ReconstructionAlgorithmTestBaseClass):
    ...
    def test_convenience_function(self):
        ...
        self.reconstructed_image_convenience = reconstruct_delay_and_sum_pytorch(time_series_sensor_data, self.device.get_detection_geometry(), reconstruction_settings[Tags.DATA_FIELD_SPEED_OF_SOUND],  1.0 / (
